...
_ACTORS: dict[str, ActorType] = {
    ...
    # Phase 1.5 controlled active reflected-XSS. The operator authorizes a single-use lease; the
    # controller admits/consumes it and correlates; ZAP's active scan and its untrusted alert
    # belong to the tool runner; only the deterministic verifier promotes; emergency stop and lease
    # revocation are controller actions.
    "ZAP_ACTIVE_LEASE_ISSUED": ActorType.CONTROLLER,
    "ZAP_ACTIVE_LEASE_CONSUMED": ActorType.CONTROLLER,
    "ZAP_ACTIVE_LEASE_REVOKED": ActorType.CONTROLLER,
    "ZAP_ACTIVE_JOB_ADMITTED": ActorType.CONTROLLER,
    "ZAP_ACTIVE_JOB_REJECTED": ActorType.CONTROLLER,
    "ZAP_ACTIVE_SCAN_STARTED": ActorType.TOOL_RUNNER,
    "ZAP_ACTIVE_SCAN_COMPLETED": ActorType.TOOL_RUNNER,
    "ZAP_ACTIVE_SCAN_FAILED": ActorType.TOOL_RUNNER,
    "ZAP_ACTIVE_ALERT_REPORTED": ActorType.TOOL_RUNNER,
    "ZAP_ACTIVE_ALERT_CORRELATED": ActorType.CONTROLLER,
    "ZAP_ACTIVE_VERIFICATION_STARTED": ActorType.VERIFIER,
    "ZAP_ACTIVE_VERIFICATION_COMPLETED": ActorType.VERIFIER,
    "ZAP_ACTIVE_EMERGENCY_STOP": ActorType.CONTROLLER,
}
...
_STAGES: dict[str, str] = {
    ...
    "ZAP_ACTIVE_LEASE_ISSUED": "ACTIVATION_LEASE",
    "ZAP_ACTIVE_LEASE_CONSUMED": "ACTIVATION_LEASE",
    "ZAP_ACTIVE_LEASE_REVOKED": "ACTIVATION_LEASE",
    "ZAP_ACTIVE_JOB_ADMITTED": "ENGINE_JOB",
    "ZAP_ACTIVE_JOB_REJECTED": "EXECUTION_POLICY",
    "ZAP_ACTIVE_SCAN_STARTED": "ACTIVE_SCAN",
    "ZAP_ACTIVE_SCAN_COMPLETED": "ACTIVE_SCAN",
    "ZAP_ACTIVE_SCAN_FAILED": "FAILED",
    "ZAP_ACTIVE_ALERT_REPORTED": "TOOL_FINDING",
    "ZAP_ACTIVE_ALERT_CORRELATED": "CORRELATION",
    "ZAP_ACTIVE_VERIFICATION_STARTED": "VERIFICATION",
    "ZAP_ACTIVE_VERIFICATION_COMPLETED": "VERIFICATION",
    "ZAP_ACTIVE_EMERGENCY_STOP": "EMERGENCY_STOP",
}
