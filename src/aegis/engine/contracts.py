...
class EngineErrorCode(StrEnum):
    ...
    # Phase 1.2 (additive): isolated-runner integrations.
    UNSUPPORTED_PROTOCOL = "UNSUPPORTED_PROTOCOL"
    RUNNER_UNAVAILABLE = "RUNNER_UNAVAILABLE"
    RUNNER_NOT_ATTESTED = "RUNNER_NOT_ATTESTED"
    RUNNER_REJECTED = "RUNNER_REJECTED"
    ENGINE_EXECUTION_INCOMPLETE = "ENGINE_EXECUTION_INCOMPLETE"
    UNSUPPORTED_JOB_TYPE = "UNSUPPORTED_JOB_TYPE"
    # Phase 1.3 (additive): controlled ZAP passive OpenAPI integration.
    PROJECTION_REJECTED = "PROJECTION_REJECTED"
    ACTIVE_SCAN_FORBIDDEN = "ACTIVE_SCAN_FORBIDDEN"
